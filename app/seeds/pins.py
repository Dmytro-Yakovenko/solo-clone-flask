...
def seed_pins():
    pin1 = Pin(
        is_saved =False,
        title='Cheeseburger',
        description="Preheat your grill, stovetop griddle, or frying pan over medium-high heat. Divide the ground beef into 4 equal portions, shaping each portion into a ball. Flatten each ball into a patty about 3/4 to 1 inch thick. Make a slight depression in the center of each patty to prevent it from puffing up during cooking.\nSeason both sides of the patties with salt and pepper. Cook the patties on the grill or stovetop for about 4-5 minutes on each side or until they reach your desired level of doneness. If you prefer well-done burgers, you can cook them a little longer. During the last minute of cooking, add a slice of cheese on top of each patty and let it melt. While the patties are cooking, lightly toast the hamburger buns on the grill or stovetop until they are warm and slightly crispy. Assemble the burgers by placing a cooked patty with melted cheese on the bottom half of each bun. Add your preferred toppings, such as lettuce, tomato slices, onions, pickles, ketchup, mustard, or mayonnaise. Place the top half of the bun on the toppings to complete the cheeseburger.",
        ingredients='1 lb (450g) ground beef (80% lean is a good choice for juiciness). Salt and pepper to taste. 4 hamburger buns.  slices of cheese (American, cheddar, or your preferred type). Optional toppings: lettuce, tomato slices, onion slices, pickles, ketchup, mustard, mayonnaise, etc.',
        time="45 minutes",
        user_id=1,
        image_url="https://res.cloudinary.com/dr1ekjmf4/image/upload/v1691267476/01a8b20022d3ac8d1c0ad960e7b67466_k0hpcu.jpg",
    ...
    pin21 = Pin(
        ...
        time="45 minutes",
        user_id=4,
        image_url="https://res.cloudinary.com/dr1ekjmf4/image/upload/v1691268413/2ff97b016673db222e6097ee64e75b72_ackgcu.jpg"
    )
    pin22 = Pin(
        is_saved =False,
        title='Falafel',
    ...
    pin47 = Pin(
        ...
        time="25 minutes",
        user_id=8,
        image_url="https://res.cloudinary.com/dr1ekjmf4/image/upload/v1691267712/c4ce2923f99c8c1eed0b1d29fbcaab68_bh1mcy.jpg"
    )
    pin48 = Pin(
        is_saved =False,
        title='Lentil Soup',
